...
public class SceneControlOriginal : MonoBehaviour
{
    private GameStatusOriginal game_status = null;
    private PlayerControlOriginal player_control = null;
    public enum STEP
    { // 게임 상태.
        NONE = -1, // 상태 정보 없음.
        PLAY = 0, // 플레이 중.
    ...
    void Start()
    {
        this.game_status = this.gameObject.GetComponent<GameStatusOriginal>();
        this.player_control =
        GameObject.Find("Player").GetComponent<PlayerControlOriginal>();
        this.step = STEP.PLAY;
